...
label_head = tk.Label(root, text="Welcome To 21 Dares",font=('Times New Roman',40),foreground='brown')
label_head.pack()
label_desp = tk.Label(root,text=para,font=('Arial',20),foreground='black')
label_desp.pack(side=tk.BOTTOM)
root.mainloop()